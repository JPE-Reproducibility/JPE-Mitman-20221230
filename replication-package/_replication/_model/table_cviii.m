...
%Scaledev       =  fullfile(scriptDir, '_aux/_models/model_1066.mat');

Benchmark      =  fullfile(scriptDir, '_aux/_models_tmp/model_1001.mat');
Scaledev       =  fullfile(scriptDir, '_aux/_models_tmp/model_1066.mat');
...
% Open the file
fid = fopen(fullfile(scriptDir, '_table/table_cviii.tex'), 'w');
...
fprintf(fid, 'Scaled Utility Cost');
