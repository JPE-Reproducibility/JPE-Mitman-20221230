...
disp('....Benchmark model coefficients....'); disp(b_1);
...
%% [1] Scaled EV model
%load('model_1066_ak.mat');
load('model_1066.mat');
forecast_moment = forecast_moments;  


TT          = 7000;

x1 = kdist_panel(:,1:TT)'; x1 = x1(:);
y1 = forecast_moment.fcerror_ur_up_4q_panel'; y1 = abs(y1(:));
...
disp('....Wealthy model coefficients....'); disp(b_2);
...
groupLabels = {'Benchmark', 'Scaled Utility Cost'};  
...
print(f, '_figures/figure_c2.pdf', '-dpdf', '-image');
