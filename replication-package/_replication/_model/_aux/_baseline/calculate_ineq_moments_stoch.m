...
[y_trend,y_cycle]=hpfilter(log(y(burnin+1:end)),lambda);
...
[u_trend,u_cycle]=hpfilter(log(unemp(burnin+1:end)),lambda);
...
[top_one_trend,top_one_cycle]=hpfilter(top_one_share(1:end),lambda);
[top_ten_trend,top_ten_cycle]=hpfilter(top_ten_share(1:end),lambda);
[ninety_nine_trend,ninety_nine_cycle]=hpfilter(ninety_nine_share(1:end),lambda);
[fifty_ninety_trend,fifty_ninety_cycle]=hpfilter(fifty_ninety_share(1:end),lambda);
[bottom_fifty_trend,bottom_fifty_cycle]=hpfilter(bottom_fifty_share(1:end),lambda);
[gini_trend,gini_cycle]=hpfilter(gini,lambda);
