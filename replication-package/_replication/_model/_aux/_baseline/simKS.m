...
zpost = params.zpost;
istates = 1:ns;
kpol = reshape(kpol_in,[nA npzp ns npk]);
ipol = reshape(ipol_in,[nk npz ns npk]);
...
for t=1:T
    ...
    cah=kdist.*(1-delta+rt - wtax*(kdist>=0)) + earn(incshocks)-params.nu*info_ac+rebate*wtax*Kt;
