 function table_moments = get_moments_table(modelname)
    ...
    table_moments.comp=[moments.kbar_mean moments.y_log_stdev moments.gini moments.p90/moments.p10 moments.p99/moments.p1 moments.p90/moments.p50 moments.info_unemp moments.info_emp];
    table_moments.ent_comp=[moments.kbar_mean moments.y_log_stdev moments.gini moments.p90/moments.p50 moments.info_unemp moments.info_emp];
